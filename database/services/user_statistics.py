    ...
    def general_test_results(self, psychologist_id: uuid.UUID):
        with session_factory() as session:
            try:
                ...
                test_titles = {
                    'Определение уровня выгорания на работе': "выгорание",
                    'Общая оценка стресса, тревоги и депрессии': 'DASS-21',
                    'Проверьте уровень тревожности': "тревоги",
                    'Узнайте, как вы справляетесь со стрессом': "копинг",
                    'Найди свои ошибки мышления': "CMQ",
                    'Оцени свой уровень апатии на работе': "апатии",
                    'Проверьте уровень депрессии': "Бека",
                    'Насколько вы стрессоустойчивы?': "Самооценка"
                }
