    ...
    def filling_in_links(self, tests):
        with session_factory() as session:
            try:
                ...
                links = [
                    "Оценка_выгорания_на_работе.png", "Тест_на_уровень_стресса_тревоги_и_депрессии.png",
                    "Определение_уровня_тревожности.png", "Как_вы_справляетесь_со_стрессом.png", "Тест_на_мышление_и_восприятие_ситуаций.png",
                    "Уровень_апатии_на_работе.png", "Определение_уровня_депрессии.png", "Тест_на_стрессоустойчивость.png"
                ]
                i = 0
                for theme in tests:
                    theme.link = links[i]
