    ...
    def filling_in_links(self, tests):
        with session_factory() as session:
            try:
                ...
                links = [
                    "/test/images_test/Оценка_выгорания_на_работе.png", "/test/images_test/Тест_на_уровень_стресса_тревоги_и_депрессии.png",
                    "/test/images_test/Определение_уровня_тревожности.png", "/test/images_test/Как_вы_справляетесь_со_стрессом.png", "/test/images_test/Тест_на_мышление_и_восприятие_ситуаций.png",
                    "/test/images_test/Уровень_апатии_на_работе.png", "/test/images_test/Определение_уровня_депрессии.png", "/test/images_test/Тест_на_стрессоустойчивость.png"
                ]
                i = 0
                for theme in tests:
                    theme.link = links[i]
